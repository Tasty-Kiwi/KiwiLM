"""Full Model E 20:1 training workload executed non-interactively on Colab."""
...
DATA_DIR = Path("/content/kiwilm-model-e-full/data")
RUN_DIR = Path("/content/kiwilm-model-e-full/run")
SUMMARY = Path("/content/kiwilm-model-e-full-summary.json")
